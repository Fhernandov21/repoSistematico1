...
public class Vehicle {
    ...
    private String model;//30   4
    private String style;//30   5
    private String vin;//20 6
    private String exteriorColor;//30   7
    private String interiorColor;//30   8
    private String miles;//7    9
    private float price;//7     10
    private Transmission transmission;//20  11
    private String engine;//50  12
    private String image;//100  13
    private String status;//20  14
